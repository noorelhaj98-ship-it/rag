"""Command-line interface for PDF chunking."""
...
def main():
    """Main entry point for PDF chunking CLI."""
    parser = argparse.ArgumentParser(description="Chunk PDF files")
    parser.add_argument(
        "source",
        nargs="?",
        help="Source PDF file (default: from config)"
    )
    parser.add_argument(
        "--jsonl",
